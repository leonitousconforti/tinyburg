...
import * as Gift from "@tinyburg/tinytower-sdk/Gift";
...
export const DeviceNewPlayerEndpoint = HttpApiEndpoint.get(
    "DeviceNewPlayer",
    `/register/${GAME_CODE}/:salt1/:salt2/:hash`,
    {
...
export const DevicePlayerDetailsEndpoint = HttpApiEndpoint.get(
    "DevicePlayerDetails",
    `/player_details/${GAME_CODE}/:playerId/:salt/:hash`,
    {
...
export const DeviceVerifyDeviceEndpoint = HttpApiEndpoint.get(
    "DeviceVerifyDevice",
    `/verify_device/${GAME_CODE}/:playerId/:verificationCode`,
    {
...
export const DeviceRegisterEmailEndpoint = HttpApiEndpoint.post(
    "DeviceRegisterEmail",
    `/register_email/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
...
export const SyncPullSaveEndpoint = HttpApiEndpoint.get(
    "SyncPullSave",
    `/sync/pull/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [
...
export const SyncPushSaveEndpoint = HttpApiEndpoint.post(
    "SyncPushSave",
    `/sync/push/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
...
export const SyncCheckForNewerSaveEndpoint = HttpApiEndpoint.get(
    ...
    `/sync/current_version/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [
...
export const SyncPullSnapshotEndpoint = HttpApiEndpoint.get(
    "SyncPullSnapshot",
    `/sync/pull_snapshot/${GAME_CODE}/:playerId/:snapshotId/:salt/:hash`,
    {
...
export const SyncPushSnapshotEndpoint = HttpApiEndpoint.post(
    "SyncPushSnapshot",
    `/sync/push_snapshot/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        payload: Schema.Struct({
            data: Schema.Uint8ArrayFromBase64,
...
export const SyncRetrieveSnapshotListEndpoint = HttpApiEndpoint.get(
    ...
    `/sync/current_snapshots/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [
...
export const RaffleEnterEndpoint = HttpApiEndpoint.get(
    "RaffleEnter",
    `/raffle/enter/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
...
export const RaffleEnterMultiEndpoint = HttpApiEndpoint.get(
    "RaffleEnterMulti",
    `/raffle/enter_multi/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [ErrorResponse, EnteredResponse, NotEnteredResponse],
...
export const RaffleCheckEnteredCurrentEndpoint = HttpApiEndpoint.get(
    ...
    `/raffle/entered_current/${GAME_CODE}/:playerId/:salt/:hash`,
    {
...
export const SocialSendItemEndpoint = HttpApiEndpoint.post(
    "SocialSendItem",
    `/send_item/${GAME_CODE}/:syncItemType/:playerId/:friendId/:salt/:hash`,
    {
        params: {
...
export const SocialGetGiftsEndpoint = HttpApiEndpoint.get(
    "SocialGetGifts",
    `/get_gifts/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [
...
export const SocialReceiveGiftEndpoint = HttpApiEndpoint.get(
    "SocialReceiveGift",
    `/receive_item/${GAME_CODE}/:playerId/:giftId/:salt/:hash`,
    {
...
export const SocialPullFriendMetaEndpoint = HttpApiEndpoint.post(
    ...
    `/friend/pull_meta/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
...
export const SocialPullFriendTowerEndpoint = HttpApiEndpoint.get(
    ...
    `/friend/pull_game/${GAME_CODE}/:playerId/:friendId/:salt/:hash`,
    {
        params: {
            playerId: NimblebitConfig.PlayerIdSchema,
            friendId: NimblebitConfig.PlayerIdSchema,
...
export const SocialRetrieveFriendsSnapshotListEndpoint = HttpApiEndpoint.get(
    ...
    `/sync/current_player_snapshots/${GAME_CODE}/:playerId/:friendId/:salt/:hash`,
    {
        params: {
            playerId: NimblebitConfig.PlayerIdSchema,
            friendId: NimblebitConfig.PlayerIdSchema,
...
export const SocialGetVisitsEndpoint = HttpApiEndpoint.get(
    "SocialGetVisits",
    `/get_visits/${GAME_CODE}/:playerId/:salt/:hash`,
    {
        params: { playerId: NimblebitConfig.PlayerIdSchema, salt: U32, hash: Schema.String },
        error: ApiErrors,
        success: [
...
/** @internal */
export const Api = HttpApi.make("TinyTowerClassicApi")
