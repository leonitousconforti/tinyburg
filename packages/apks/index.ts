...
// prettier-ignore
// eslint-disable-next-line @rushstack/typedef-var
export const ApkmirrorVersions = ["3.0.1", "3.3.10", "3.6.6", "3.7.3", "3.8.0", "3.9.1", "3.10.1", "3.11.1", "3.12.0", "3.12.1", "3.12.2", "3.12.3", "3.12.4", "3.13.0", "3.13.1", "3.13.2", "3.14.0", "3.14.1", "3.14.2", "3.15.0", "3.15.1", "3.15.2", "3.15.4", "3.16.0", "3.16.1", "3.16.2", "3.16.3", "3.16.4", "3.16.5", "3.16.6", "4.0.0", "4.0.1", "4.0.3", "4.0.4", "4.0.5", "4.0.6", "4.1.0", "4.2.0", "4.2.1", "4.3.0", "4.3.1", "4.4.0", "4.5.0", "4.6.0", "4.7.0", "4.7.1", "4.8.0", "4.9.0", "4.10.0", "4.11.1"] as const;
