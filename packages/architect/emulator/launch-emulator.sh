...
/android/sdk/emulator/emulator -avd Pixel2 -no-window -gpu swiftshader_indirect -ports 5554,5555 -grpc 8554 -read-only -snapshot-list -turncfg 'printf {"iceServers":[{"urls":["stun:stun.l.google.com:19302"]}]}' &
