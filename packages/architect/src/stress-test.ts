...
const TOTAL_ITERATIONS: number = Number.parseInt(process.env["ARCHITECT_STRESS_TOTAL_ITERATIONS"] as string, 10) || 25;
...
for (let run_index: number = 0; run_index < TOTAL_ITERATIONS; run_index++) {
