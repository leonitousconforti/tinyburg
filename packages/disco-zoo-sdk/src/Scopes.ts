/**
 * The scopes the Disco Zoo api is guarded by, as a game-rooted tree, built with
 ...
 * @category Games
 */
export const DiscoZoo = defineGame({
    name: "discozoo",
    description: "Disco Zoo",
    read: { description: "Everything in Disco Zoo that only looks" },
    write: { description: "Everything in Disco Zoo that changes a player's game" },
    areas: {
        device: {
 ...
 * @category Areas
 */
export const { device: Device, social: Social } = DiscoZoo.areas;

/**
 * @since 1.0.0
 * @category Tree
 */
export const Games: ReadonlyArray<Game> = [DiscoZoo];
