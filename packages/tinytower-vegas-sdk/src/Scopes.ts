/**
 * The scopes the Tiny Tower Vegas api is guarded by, as a game-rooted tree, built with
 ...
 * @category Games
 */
export const TinyTowerVegas = defineGame({
    name: "tinytowervegas",
    description: "Tiny Tower Vegas",
    read: { description: "Everything in Tiny Tower Vegas that only looks" },
    write: { description: "Everything in Tiny Tower Vegas that changes a player's game" },
    areas: {
        device: {
 ...
 * @category Areas
 */
export const { device: Device, social: Social } = TinyTowerVegas.areas;

/**
 * @since 1.0.0
 * @category Tree
 */
export const Games: ReadonlyArray<Game> = [TinyTowerVegas];
