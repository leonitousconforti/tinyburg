...
export const floors = [
    ...
    { name: "never", type: floorType.None },
    ...
    { name: "Easter Island Lobby", type: floorType.Lobby },
    { name: "Lecture Hall Lobby", type: floorType.Lobby },
    { name: "Retro Ice Cream Lobby", type: floorType.Lobby },
    { name: "Underwater Ice Cream Parlor Lobby", type: floorType.Lobby },
] as const;
