...
const loggingNamespace = "tinyburg:compare_saves";
...
export const whichSaveIsBetter = async function <T extends INimblebitJsonSave | DecompressedSave>(
    ...
    const parsedSave1_stories = !parsedSave1.stories ? [] : parsedSave1.stories;
    const parsedSave2_stories = !parsedSave2.stories ? [] : parsedSave2.stories;
    const parsedSave1_totalPoints = !parsedSave1.totalPoints ? 0 : parsedSave1.totalPoints;
    const parsedSave2_totalPoints = !parsedSave2.totalPoints ? 0 : parsedSave2.totalPoints;
