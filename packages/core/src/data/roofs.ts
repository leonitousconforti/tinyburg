 ...
 *
 * On: Sun, 08 Oct 2023 08:42:43 GMT
 */

export const numberOfRoofs = 57 as const;
...
export const roofs = [
    ...
    { name: "Dollhouse roof", buxcost: 1000, contentOffer: true, fwcolors: [], animations: [] },
    { name: "Hobitizen", buxcost: 1000, contentOffer: true, fwcolors: [], animations: [] },
] as const;
