 ...
 *
 * Generated by: /workspaces/tinyburg/packages/insight/dist/src/agents/get-elevator-data.js
 *
 * with TinyTower version: 4.21.0
 *
 * on: Fri, 09 Jun 2023 06:03:27 GMT
 */
...
export const numberElevators = 27 as const;
...
export const elevators = [
    {
        ...
        yoffset: "-12",
        animations: [
            { element: "elevatorflicker", x: 0, y: 65, frontlayer: 1, ftime: "0.1", loopdelay: ["0.25", "20"] },
            { element: "sparks", x: 2, y: 34, ftime: "0.05", frontlayer: 1, additive: true, loopdelay: ["3", "20"] },
        ],
    },
    {
    ...
    },
    {
        ...
        animations: [
            ...
            { element: "goldshine", x: 0, y: 65, ftime: "0.04", loopdelay: ["4", "20"] },
        ],
    },
    {
    ...
    { name: "Independence Lift", buxcost: 9999, hidden: true, yoffset: "-11" },
