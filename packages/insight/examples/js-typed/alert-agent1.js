 ...
 * node.js side
 *
 * @extends TinyTowerFridaAgent<SubscribeToMusicStatusAgent1>
 */
export class SubscribeToMusicStatusAgent1 extends TinyTowerFridaAgent {
    /**
     * @param {(status: boolean) => void} onAccessCallback
     * @param {number} [loadDependenciesMaxRetries]
     * @param {number} [loadDependenciesWaitMs]
     */
