...
import { isDSO, isEnumerable, isList } from "./is.js";

export const readObject = (
    object: Il2Cpp.Object
): boolean | number | string | NativePointer | Array<unknown> | undefined => {
...
export const readField = (
    field: Il2Cpp.Field
): string | number | boolean | NativePointer | undefined | Array<unknown> => {
