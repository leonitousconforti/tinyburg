...
export const isEnumerable = (object: Il2Cpp.Object): boolean => {
    const systemEnumerableInterface = Il2Cpp.Image.corlib.class("System.Collections.IEnumerable");
    return object.class.isSubclassOf(systemEnumerableInterface, true);
};

export const isList = (object: Il2Cpp.Object): boolean => {
    const systemListClass = Il2Cpp.Image.corlib.class("System.Collections.IList");
    const systemCollectionClass = Il2Cpp.Image.corlib.class("System.Collections.ICollection");
