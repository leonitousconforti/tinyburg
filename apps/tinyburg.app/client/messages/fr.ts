...
export const fr: Messages = {
    ...
    titles: {
        ...
        trades: "Échanges | Tinyburg",
        tradeDetail: "Échange | Tinyburg",
    ...
    towerMe: {
        ...
        tradesRow: {
            title: "Échanges",
            detail: "Échange des bitizens et plus, sous séquestre de la trésorerie",
        },
        accountRow: {
    ...
    trades: {
        ...
        heading: "Échanges",
        tagline: "Échange des bitizens et plus encore, sous séquestre de la trésorerie.",
        duplicationNote:
            "Attention : les échanges par cadeau envoient une copie de chaque objet via le coffre de la trésorerie - l'objet n'est pas retiré de la tour de l'expéditeur. Les échanges par fusion de sauvegardes déplacent vraiment les objets, et les deux parties doivent confirmer avant qu'une sauvegarde ne soit touchée.",
        connectHeading: "Connecter la trésorerie",
        connectBody:
            "Pour mettre tes échanges sous séquestre, la trésorerie a besoin de ta permission pour agir sur tes tours reliées en ton absence. Tu peux la révoquer à tout moment.",
        connectButton: "Connecter",
        loading: "Chargement...",
        loadFailed: "Impossible de charger. Réessaie dans un instant.",
        notices: {
            connected: "La trésorerie est connectée à tes tours.",
            proposed: "Échange proposé !",
            accepted: "Échange accepté - la trésorerie le met sous séquestre.",
            cancelled: "Échange annulé.",
            confirmed: "Confirmation enregistrée.",
        },
        problems: {
            connectFailed: "La connexion à la trésorerie n'a pas abouti. Réessaie.",
            badOffer: "Cette offre est illisible. Vérifie les codes ami et les objets.",
            notAllowed:
                "La trésorerie ne peut pas agir pour cette tour. Connecte-la d'abord et vérifie que la tour est reliée à ton compte.",
            actionFailed: "Ça n'a pas fonctionné. Réessaie dans un instant.",
            conflict: "Cet échange a évolué ; recharge pour voir où il en est.",
        },
        proposeHeading: "Proposer un échange",
        proposeToggle: "Nouvel échange",
        proposeCancel: "Finalement non",
        mechanismLabel: "Comment déplacer les objets ?",
        mechanismGift: "Canal des cadeaux",
        mechanismSplice: "Fusion de sauvegardes",
        yourTowerLabel: "Ton code ami",
        pickTower: "Choisis une de tes tours reliées.",
        orTypeCode: "Saisis le code ami d'une de tes tours reliées.",
        counterpartyLabel: "Son code ami",
        counterpartyHint: "Laisse vide pour une offre ouverte que n'importe qui peut accepter.",
        youGiveLabel: "Tu donnes",
        youWantLabel: "Tu veux",
        available: (count: number) =>
            count === 1 ? "1 objet échangeable dans cette tour :" : `${count} objets échangeables dans cette tour :`,
        balance: (amount: string) => `Cette tour possède ${amount}.`,
        inventoryLoadFailed: "Impossible de lire les objets de cette tour ; saisis l'objet à la main.",
        wantHint: "L'objet attendu en retour, sous forme de chaîne encodée - demande-la à l'autre partie.",
        itemHint: "La chaîne encodée de l'objet, p. ex. bit:...",
        amountHint: "Le montant à transférer.",
        kinds: { bitizen: "Bitizen", costume: "Costume", pet: "Animal", coins: "Pièces", bux: "Bux" },
        ttlLabel: "L'offre expire après (heures)",
        submitPropose: "Proposer l'échange",
        proposing: "Proposition en cours...",
        tradesHeading: "Tes échanges et offres ouvertes",
        emptyTrades: "Pas encore d'échange. Propose le premier !",
        openOffer: "offre ouverte",
        viewTrade: "Voir →",
        gives: (what: string) => `Donne : ${what}`,
        wants: (what: string) => `Veut : ${what}`,
        expires: (date: string) => `Expire le ${date}`,
        mechanisms: { gift: "cadeau", splice: "fusion" },
        states: {
            proposed: "Proposé",
            accepted: "Accepté",
            awaiting_confirmation: "En attente de confirmation",
            escrowing: "Mise sous séquestre",
        ...
        legsHeading: "Étapes du séquestre",
        historyHeading: "Historique",
        acceptPlayerLabel: "Accepter avec ton code ami",
        acceptButton: "Accepter l'échange",
        accepting: "Acceptation...",
        cancelButton: "Annuler l'échange",
        confirmWarning:
            "En confirmant, tu autorises la trésorerie à réécrire les deux sauvegardes pour réaliser cet échange. Des instantanés cloud sont pris d'abord, mais ferme ton jeu et ne joue pas avant la fin de l'échange.",
        confirmButton: "Compris - confirmer la fusion",
        awaitingOther: "Tu as confirmé. En attente de l'autre partie.",
        failureReason: (reason: string) => `Échec : ${reason}`,
    },
    notFound: {
