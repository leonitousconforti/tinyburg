...
export const de: Messages = {
    ...
    titles: {
        ...
        trades: "Trades | Tinyburg",
        tradeDetail: "Trade | Tinyburg",
    ...
    towerMe: {
        ...
        tradesRow: {
            title: "Trades",
            detail: "Tausche Bitizens und mehr, verwahrt vom Treasury",
        },
        accountRow: {
    ...
    trades: {
        ...
        backToTrades: "← Zurück zu den Trades",
        heading: "Trades",
        tagline: "Tausche Bitizens und mehr, treuhänderisch verwahrt vom Treasury.",
        duplicationNote:
            "Hinweis: Geschenk-Trades senden eine Kopie jedes Items durch den Tresor des Treasury - das Item wird nicht aus dem Turm des Absenders entfernt. Save-Splice-Trades verschieben Items wirklich, und beide Handelspartner müssen bestätigen, bevor ein Spielstand angefasst wird.",
        connectHeading: "Treasury verbinden",
        connectBody:
            "Um deine Trades zu verwahren, braucht das Treasury deine Erlaubnis, in deiner Abwesenheit auf deine verknüpften Türme zuzugreifen. Du kannst sie jederzeit widerrufen.",
        connectButton: "Verbinden",
        loading: "Lädt...",
        loadFailed: "Konnte nicht geladen werden. Versuche es gleich noch einmal.",
        notices: {
            connected: "Das Treasury ist mit deinen Türmen verbunden.",
            proposed: "Trade vorgeschlagen!",
            accepted: "Trade angenommen - das Treasury verwahrt ihn jetzt.",
            cancelled: "Trade abgebrochen.",
            confirmed: "Bestätigung gespeichert.",
        },
        problems: {
            connectFailed: "Die Verbindung zum Treasury wurde nicht abgeschlossen. Versuche es erneut.",
            badOffer: "Dieses Angebot lässt sich nicht lesen. Prüfe die Freundescodes und Items.",
            notAllowed:
                "Das Treasury kann für diesen Turm nicht handeln. Verbinde es zuerst und stelle sicher, dass der Turm mit deinem Konto verknüpft ist.",
            actionFailed: "Das hat nicht geklappt. Versuche es gleich noch einmal.",
            conflict: "Dieser Trade ist weitergezogen; lade neu, um den Stand zu sehen.",
        },
        proposeHeading: "Trade vorschlagen",
        proposeToggle: "Neuer Trade",
        proposeCancel: "Doch nicht",
        mechanismLabel: "Wie sollen die Items bewegt werden?",
        mechanismGift: "Geschenk-Kanal",
        mechanismSplice: "Save-Splice",
        yourTowerLabel: "Dein Freundescode",
        pickTower: "Wähle einen deiner verknüpften Türme.",
        orTypeCode: "Gib den Freundescode eines deiner verknüpften Türme ein.",
        counterpartyLabel: "Ihr Freundescode",
        counterpartyHint: "Leer lassen für ein offenes Angebot, das jeder annehmen kann.",
        youGiveLabel: "Du gibst",
        youWantLabel: "Du möchtest",
        available: (count: number) =>
            count === 1 ? "1 tauschbares Item in diesem Turm:" : `${count} tauschbare Items in diesem Turm:`,
        balance: (amount: string) => `Dieser Turm besitzt ${amount}.`,
        inventoryLoadFailed: "Die Items dieses Turms konnten nicht gelesen werden; gib das Item von Hand ein.",
        wantHint: "Das Item, das du zurückerwartest, als kodierter String - frage den anderen Handelspartner danach.",
        itemHint: "Der kodierte Item-String, z. B. bit:...",
        amountHint: "Der zu übertragende Betrag.",
        kinds: { bitizen: "Bitizen", costume: "Kostüm", pet: "Haustier", coins: "Münzen", bux: "Bux" },
        ttlLabel: "Angebot läuft ab nach (Stunden)",
        submitPropose: "Trade vorschlagen",
        proposing: "Wird vorgeschlagen...",
        tradesHeading: "Deine Trades & offene Angebote",
        emptyTrades: "Noch keine Trades. Schlage den ersten vor!",
        openOffer: "offenes Angebot",
        viewTrade: "Ansehen →",
        gives: (what: string) => `Gibt: ${what}`,
        wants: (what: string) => `Möchte: ${what}`,
        expires: (date: string) => `Läuft ab am ${date}`,
        mechanisms: { gift: "Geschenk", splice: "Splice" },
        states: {
            proposed: "Vorgeschlagen",
            accepted: "Angenommen",
            awaiting_confirmation: "Wartet auf Bestätigung",
            escrowing: "Wird verwahrt",
            escrowed: "Verwahrt",
        ...
        legStates: {
            ...
            settled: "Abgeschlossen",
            refund_sent: "Erstattung gesendet",
            refunded: "Erstattet",
            lost: "Verloren",
        },
        legsHeading: "Treuhand-Schritte",
        historyHeading: "Verlauf",
        acceptPlayerLabel: "Annehmen mit deinem Freundescode",
        acceptButton: "Trade annehmen",
        accepting: "Wird angenommen...",
        cancelButton: "Trade abbrechen",
        confirmWarning:
            "Mit der Bestätigung darf das Treasury beide Spielstände umschreiben, um diesen Trade auszuführen. Vorher werden Cloud-Snapshots angelegt, aber schließe dein Spiel und spiele nicht weiter, bis der Trade abgeschlossen ist.",
        confirmButton: "Verstanden - Splice bestätigen",
        awaitingOther: "Du hast bestätigt. Warte auf den anderen Handelspartner.",
        failureReason: (reason: string) => `Fehlgeschlagen: ${reason}`,
    },
    notFound: {
