...
export const es: Messages = {
    ...
    titles: {
        ...
        trades: "Intercambios | Tinyburg",
        tradeDetail: "Intercambio | Tinyburg",
    ...
    towerMe: {
        ...
        tradesRow: {
            title: "Intercambios",
            detail: "Intercambia bitizens y más, con la tesorería como garantía",
        },
        accountRow: {
    ...
    trades: {
        backToHome: "← Volver al inicio",
        backToTrades: "← Volver a los intercambios",
        heading: "Intercambios",
        tagline: "Intercambia bitizens y más, con la tesorería como depósito de garantía.",
        duplicationNote:
            "Aviso: los intercambios por regalo envían una copia de cada objeto a través de la bóveda de la tesorería; el objeto no se elimina de la torre del remitente. Los intercambios por empalme de partidas mueven los objetos de verdad, y ambas partes deben confirmar antes de tocar ninguna partida.",
        connectHeading: "Conectar la tesorería",
        connectBody:
            "Para custodiar tus intercambios, la tesorería necesita tu permiso para actuar sobre tus torres vinculadas mientras no estás. Puedes revocarlo en cualquier momento.",
        connectButton: "Conectar",
        loading: "Cargando...",
        loadFailed: "No se pudo cargar. Inténtalo de nuevo en un momento.",
        notices: {
            connected: "La tesorería está conectada a tus torres.",
            proposed: "¡Intercambio propuesto!",
            accepted: "Intercambio aceptado: la tesorería ya lo está custodiando.",
            cancelled: "Intercambio cancelado.",
            confirmed: "Confirmación registrada.",
        },
        problems: {
            connectFailed: "La conexión con la tesorería no terminó. Inténtalo de nuevo.",
            badOffer: "Esa oferta no se puede leer. Revisa los códigos de amigo y los objetos.",
            notAllowed:
                "La tesorería no puede actuar por esa torre. Conéctala primero y asegúrate de que la torre está vinculada a tu cuenta.",
            actionFailed: "No se pudo completar. Inténtalo de nuevo en un momento.",
            conflict: "Este intercambio ya avanzó; recarga para ver su estado.",
        },
        proposeHeading: "Proponer un intercambio",
        proposeToggle: "Nuevo intercambio",
        proposeCancel: "Mejor no",
        mechanismLabel: "¿Cómo deben moverse los objetos?",
        mechanismGift: "Canal de regalos",
        mechanismSplice: "Empalme de partidas",
        yourTowerLabel: "Tu código de amigo",
        pickTower: "Elige una de tus torres vinculadas.",
        orTypeCode: "Escribe el código de amigo de una de tus torres vinculadas.",
        counterpartyLabel: "Su código de amigo",
        counterpartyHint: "Déjalo en blanco para una oferta abierta que cualquiera pueda aceptar.",
        youGiveLabel: "Tú das",
        youWantLabel: "Tú quieres",
        available: (count: number) =>
            count === 1 ? "1 objeto intercambiable en esta torre:" : `${count} objetos intercambiables en esta torre:`,
        balance: (amount: string) => `Esta torre tiene ${amount}.`,
        inventoryLoadFailed: "No se pudieron leer los objetos de esta torre; escribe el objeto a mano.",
        wantHint: "El objeto que esperas a cambio, como su cadena codificada: pídesela a la otra persona.",
        itemHint: "La cadena codificada del objeto, p. ej. bit:...",
        amountHint: "La cantidad a transferir.",
        kinds: { bitizen: "Bitizen", costume: "Disfraz", pet: "Mascota", coins: "Monedas", bux: "Bux" },
        ttlLabel: "La oferta caduca en (horas)",
        submitPropose: "Proponer intercambio",
        proposing: "Proponiendo...",
        tradesHeading: "Tus intercambios y ofertas abiertas",
        emptyTrades: "Aún no hay intercambios. ¡Propón el primero!",
        openOffer: "oferta abierta",
        viewTrade: "Ver →",
        gives: (what: string) => `Da: ${what}`,
        wants: (what: string) => `Quiere: ${what}`,
        expires: (date: string) => `Caduca el ${date}`,
        mechanisms: { gift: "regalo", splice: "empalme" },
        states: {
            proposed: "Propuesto",
            accepted: "Aceptado",
            awaiting_confirmation: "Esperando confirmación",
            escrowing: "En depósito",
            escrowed: "Depositado",
            releasing: "Liberando",
        ...
        legStates: {
            pending: "Pendiente",
            sent: "Enviado",
            verified: "En la bóveda",
            released: "Liberado",
            settled: "Completado",
            refund_sent: "Reembolso enviado",
            refunded: "Reembolsado",
            lost: "Perdido",
        },
        legsHeading: "Tramos del depósito",
        historyHeading: "Historial",
        acceptPlayerLabel: "Aceptar con tu código de amigo",
        acceptButton: "Aceptar intercambio",
        accepting: "Aceptando...",
        cancelButton: "Cancelar intercambio",
        confirmWarning:
            "Al confirmar, la tesorería podrá reescribir ambas partidas para ejecutar este intercambio. Antes se toman instantáneas en la nube, pero cierra el juego y no juegues hasta que se complete.",
        confirmButton: "Entendido: confirmar el empalme",
        awaitingOther: "Has confirmado. Esperando a la otra persona.",
        failureReason: (reason: string) => `Fallido: ${reason}`,
    },
    notFound: {
