...
export const en: Messages = {
    ...
    towerMe: {
        ...
        tradesRow: {
            title: "Trades",
            detail: "Trade bitizens and more, escrowed by the treasury",
        },
        accountRow: {
    ...
    trades: {
        ...
        heading: "Trades",
        tagline: "Trade bitizens and more, escrowed by the treasury.",
        duplicationNote:
            "Heads up: gift trades send a copy of each item through the treasury's vault - the item is not removed from the sender's tower. Save-splice trades move items for real, and both traders must confirm before any save is touched.",
        connectHeading: "Connect the Treasury",
        connectBody:
            "To escrow your trades, the treasury needs your permission to act on your linked towers while you are away. You can revoke it at any time.",
        connectButton: "Connect",
        loading: "Loading...",
        loadFailed: "Could not load. Try again in a moment.",
        notices: {
            connected: "The treasury is connected to your towers.",
            proposed: "Trade proposed!",
            accepted: "Trade accepted - the treasury is escrowing it now.",
            cancelled: "Trade cancelled.",
            confirmed: "Confirmation recorded.",
        },
        problems: {
            connectFailed: "Connecting the treasury did not finish. Try again.",
            badOffer: "That offer does not parse. Check the friend codes and items.",
            notAllowed:
                "The treasury cannot act for that tower. Connect it first, and make sure the tower is linked to your account.",
            actionFailed: "That did not go through. Try again in a moment.",
            conflict: "This trade has moved on; refresh to see where it stands.",
        },
        proposeHeading: "Propose a Trade",
        proposeToggle: "New Trade",
        proposeCancel: "Never Mind",
        mechanismLabel: "How should the items move?",
        mechanismGift: "Gift channel",
        mechanismSplice: "Save splice",
        yourTowerLabel: "Your friend code",
        pickTower: "Pick one of your linked towers.",
        orTypeCode: "Type the friend code of one of your linked towers.",
        counterpartyLabel: "Their friend code",
        counterpartyHint: "Leave blank to make an open offer anyone can accept.",
        youGiveLabel: "You give",
        youWantLabel: "You want",
        available: (count: number) =>
            count === 1 ? "1 tradable item in this tower:" : `${count} tradable items in this tower:`,
        balance: (amount: string) => `This tower holds ${amount}.`,
        inventoryLoadFailed: "Could not read this tower's items; type the item by hand.",
        wantHint: "The item you expect back, as its encoded string - ask the other trader for it.",
        itemHint: "The encoded item string, e.g. bit:...",
        amountHint: "The amount to transfer.",
        kinds: { bitizen: "Bitizen", costume: "Costume", pet: "Pet", coins: "Coins", bux: "Bux" },
        ttlLabel: "Offer expires after (hours)",
        submitPropose: "Propose Trade",
        proposing: "Proposing...",
        tradesHeading: "Your Trades & Open Offers",
        emptyTrades: "No trades yet. Propose the first one!",
        openOffer: "open offer",
        viewTrade: "View →",
        gives: (what: string) => `Gives: ${what}`,
        wants: (what: string) => `Wants: ${what}`,
        expires: (date: string) => `Expires ${date}`,
        mechanisms: { gift: "gift", splice: "splice" },
        states: {
            proposed: "Proposed",
            accepted: "Accepted",
        ...
        legsHeading: "Escrow Legs",
        historyHeading: "History",
        acceptPlayerLabel: "Accept with your friend code",
        acceptButton: "Accept Trade",
        accepting: "Accepting...",
        cancelButton: "Cancel Trade",
        confirmWarning:
            "Confirming lets the treasury rewrite both saves to carry out this trade. Cloud snapshots are taken first, but close your game and do not play until it settles.",
        confirmButton: "I Understand - Confirm the Splice",
        awaitingOther: "You have confirmed. Waiting for the other trader.",
        failureReason: (reason: string) => `Failed: ${reason}`,
    },
    notFound: {
