...
import { Endpoints } from "@tinyburg/tinytower-vegas-sdk";

import { AuthProxyApiDecodeHash, AuthProxyApiDecodeHashLive } from "../middleware/20_tinytowerDecode.ts";

/** @internal */
class Client extends Context.Service<Client>()("TinyTowerVegasClient", {
...
/**
 * @since 1.0.0
 * @category Tiny Tower Vegas Routes
 */
export const TinyTowerVegasDeviceManagementLive = HttpApiBuilder.group(
    Api,
 ...
 * @category Tiny Tower Vegas Routes
 */
export const TinyTowerVegasSyncManagementLive = HttpApiBuilder.group(
    Api,
    "SyncManagementGroup",
    Effect.fnUntraced(function* (handlers) {
 ...
 * @category Tiny Tower Vegas Routes
 */
export const TinyTowerVegasSocialLive = HttpApiBuilder.group(
    Api,
    "SocialGroup",
    Effect.fnUntraced(function* (handlers) {
 ...
 * @category Tiny Tower Vegas Routes
 */
export const TinyTowerVegasApiLive = HttpApiBuilder.layer(Api).pipe(
    Layer.provide([TinyTowerVegasDeviceManagementLive, TinyTowerVegasSyncManagementLive, TinyTowerVegasSocialLive]),
