...
/**
 * Serves the built self-service dashboard. `spa: true` gives the index.html
 * fallback for client routes like /keys, while the proxy's own registered
 * routes keep winning over the fallback.
 */
