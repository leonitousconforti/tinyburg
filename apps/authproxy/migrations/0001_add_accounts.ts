...
export default Effect.flatMap(
    ...
    (sql) => sql`
        ...
        INSERT INTO accounts (key, last_used_at, rate_limit_limit, rate_limit_window, scopes)
        VALUES ('00000000-0000-0000-0000-000000000001', NOW(), 3, (EXTRACT(EPOCH FROM INTERVAL '1 minute') * 1000)::BIGINT, ARRAY[]::TEXT[])
        ON CONFLICT (key) DO NOTHING;

        -- "Default" account with read-only scopes
        INSERT INTO accounts (key, last_used_at, rate_limit_limit, rate_limit_window, scopes)
        VALUES ('00000000-0000-0000-0000-000000000002', NOW(), 3, (EXTRACT(EPOCH FROM INTERVAL '1 minute') * 1000)::BIGINT, ARRAY[
            '/player_details/tt/',
            '/sync/pull/tt/',
