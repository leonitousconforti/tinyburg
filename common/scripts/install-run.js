...
/***/ (() => {
  ...
  \************************************************/
            /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                 ...
                 *
                 * @returns The text of the the .npmrc.
                 */
                ...
                /**
                 * As a workaround, copyAndTrimNpmrcFile() copies the .npmrc file to the target
                 * folder, and also trims unusable lines from the .npmrc file.
                 *
                 * Why are we trimming the .npmrc lines? NPM allows environment variables to be
                 * specified in the .npmrc file to provide different authentication tokens for
                 * different registry. However, if the environment variable is undefined, it
                 * expands to an empty string, which produces a valid-looking mapping with an
                 * invalid URL that causes an error. Instead, we'd prefer to skip that line and
                 * continue looking in other places such as the user's home directory.
                 *
                 * @returns The text of the the .npmrc with lines containing undefined
                ...
                /**
                 * SyncNpmrc() copies the .npmrc file to the target folder, and also trims
                 * unusable lines from the .npmrc file. If the source .npmrc file not exist,
                 * then syncNpmrc() will delete an .npmrc that is found in the target folder.
                 *
                 * IMPORTANT: THIS CODE SHOULD BE KEPT UP TO DATE WITH Utilities._syncNpmrc()
                 *
                 * @returns The text of the the synced .npmrc, if one exists. If one does not
                 *   exist, then undefined is returned.
                 */
                function syncNpmrc(
                    sourceNpmrcFolder,
                    targetNpmrcFolder,
  ...
  \*******************************************/
        ...
        /**
         * Parse a package specifier (in the form of name@version) into name and version
         * parts.
         */
        ...
        /**
         * Create missing directories under the specified base directory, and return the
         * resolved directory.
         *
         * Does not support "." or ".." path segments. Assumes the baseFolder exists.
         */
        ...
        /**
         * Compare version strings according to semantic versioning. Returns a positive
         * integer if "a" is a later version than "b", a negative integer if "b" is
         * later than "a", and 0 otherwise.
         */
        ...
        /**
         * Write a flag file to the package's install directory, signifying that the
